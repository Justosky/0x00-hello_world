...
/**
 * _print - This function moves a string one place to
 * the left and prints the string
 * @str: The string to be  moved
 * @l: The size of string the string to be moved
 * Return: void
 */
...
/**
 * mul - This multiplies a char with a string and
...
/**
 * check_for_digits - This checks the arguments to ensure
 * they are digits
 ...
 * @l: length of string
 * Return: This function returns nothing or void
 */
